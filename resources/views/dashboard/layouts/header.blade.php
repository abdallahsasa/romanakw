<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-start navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="/backoffice/dashboard"><img src="{{asset('/img/ui/logo.png')}}" alt="" > Panel</a>
        <a class="navbar-brand brand-logo-mini" href="/backoffice/dashboard"><img src="{{asset('/img/ui/logo.png')}}" alt=""> Panel</a>
    </div>
    <!-- Top bar left -->
    ...
    <ul class="nav navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item " style="display: none;" href="#"><i class="text-secondary ti-reload"></i>Activity</a>
                <a class="dropdown-item " style="display: none;" href="#"><i class="text-success ti-email"></i>Messages</a>
                <a class="dropdown-item " style="display: none;" href="#"><i class="text-dark ti-layers-alt"></i>Projects <span class="badge bg-info">6</span> </a>
