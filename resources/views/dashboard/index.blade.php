                        ...
                        <div class="d-block d-md-flex justify-content-between">
                            ...
                            <div class="d-block d-md-flex nav-tabs-custom">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active show" id="months-tab" data-bs-toggle="tab"
                                           href="#months" role="tab" aria-controls="months"
                                           aria-selected="true"> Months</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="year-tab" data-bs-toggle="tab" href="#year"
                            ...
                            <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                ...
                                <div class="row mb-20">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <p class="sm-mb-5 d-block">Success to you and then pull it out when you
                                            are.</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <p class="sm-mb-5 d-block">The first thing to remember about success is
                                            that. </p>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-3 w-100">
                                    <h6 class="mt-0 mb-0">Car dealer <span
                                            class="float-end text-danger"> 8,561</span></h6>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-3 w-100">
                                    <h6 class="mt-0 mb-0">Webster <span
                                            class="float-end text-warning"> 6,213</span></h6>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-3 w-100">
                                    <h6 class="mt-0 mb-0">The corps <span
                                            class="float-end text-success"> 2,926</span></h6>
